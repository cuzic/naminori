...
export default defineContext({
  ...
  applicableTechniques: [
    'achievement-evidence', 'impostor-normalize', 'competence-journal',
    'feedback-portfolio', 'luck-vs-skill',
    'inner-critic', 'shame-resilience', 'self-compassion-3steps',
    'cognitive-reappraisal', 'thought-record', 'core-beliefs',
    'growth-mindset', 'reframing', 'self-distancing',
  ],
  i18n: {
    ja: {
