...
export default defineContext({
  ...
  applicableTechniques: [
    'role-switching-ritual', 'digital-sunset', 'ideal-week-design', 'off-identity',
    'work-detach', 'shutdown-ritual', 'boundary-message', 'energy-audit',
    'values-compass', 'rest-types', 'needs-inventory', 'please-check',
    'self-compassion-3steps', 'problem-solving', 'behavioral-activation',
  ],
  i18n: {
    ja: {
      label: '仕事に追われて休めない',
